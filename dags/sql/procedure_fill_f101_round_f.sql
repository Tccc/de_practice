...
begin
    ...
    insert 
      into dm.dm_f101_round_f
          ...
          from
            (
              select  date_trunc('month', to_date('2018-01-31', 'yyyy-mm-dd'))        as from_date,
                    (date_trunc('MONTH', to_date('2018-01-31', 'yyyy-mm-dd')) + INTERVAL '1 MONTH - 1 day')  as to_date,
